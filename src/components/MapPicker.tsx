...
// Fix default marker icons (Vite doesn't bundle Leaflet's image paths)
const icon = L.icon({
...
export function MapPicker({ initial, onChange, height = 280 }: Props) {
  ...
  // Auto-detect on first mount if no initial
  useEffect(() => {
